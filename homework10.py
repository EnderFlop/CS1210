...
def getMapUrl():
   ...
   args = f"center={lat},{lng}&zoom={Globals.zoomLevel}&size={Globals.mapSize}x{Globals.mapSize}&markers=size:mid|{lat},{lng}&maptype={Globals.mapType.get()}&format=gif"
...
def initializeGUIetc():
   ...
   helpLabel = tkinter.Label(mainFrame, text="Input Place ->")
